...
public final class EnhanMessCommand extends CommandBase {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "mp":
                handlePrefixSetting(
                    ...
                    "Message prefix",
                    EnhanMess::toggleMessagePrefixEnabled,
                    EnhanMess::setMessagePrefix,
                    EnhanMess::getMessagePrefix
                );
                return;
            case "cp":
                handlePrefixSetting(
                    ...
                    "/em cp <toggle|set <command>>",
                    "Command prefix",
                    EnhanMess::toggleCommandPrefixEnabled,
                    EnhanMess::setCommandPrefix,
                    EnhanMess::getCommandPrefix
                );
                return;
            case "mc":
                handleIntSet(
                    ...
                    EnhanMess::setMessageDelaySeconds,
            ...
            case "cc":
                handleIntSet(
                    ...
                    Reference.MIN_DELAY_SECONDS,
                    Reference.MAX_DELAY_SECONDS,
                    EnhanMess::setCommandDelaySeconds,
                    value -> EnumChatFormatting.AQUA + formatSeconds(value)
                );
                return;
            case "h":
                handleIntSet(
                    ...
                    EnhanMess::setMessageHistoryLength,
    ...
    private void handleMainToggle(ICommandSender sender, String[] args)
        ...
        boolean enabled = EnhanMess.toggleEnabled();
